...
namespace RuStore.BillingClient {
    ...
    public class RuStoreBillingClient {
        ...
        public bool Init(RuStoreBillingClientConfig config) {
            ...
            _clientWrapper.Call("init", config.consoleApplicationId, config.deeplinkScheme, config.allowNativeErrorHandling, config.enableLogs);
            _isInitialized = true;
        ...
        public void GetProducts(string[] productIds, Action<RuStoreError> onFailure, Action<ProductsResponse> onSuccess) {
            if (!IsPlatformSupported(onFailure)) {
                return;
            }
        ...
        public void GetPurchases(Action<RuStoreError> onFailure, Action<PurchasesResponse> onSuccess) {
            if (!IsPlatformSupported(onFailure)) {
                return;
            }
        ...
        public void GetPurchaseInfo(string purchaseId, Action<RuStoreError> onFailure, Action<PurchaseInfoResponse> onSuccess) {
            if (!IsPlatformSupported(onFailure)) {
                return;
            }
        ...
        public void ConfirmPurchase(string purchaseId, Action<RuStoreError> onFailure, Action<ConfirmPurchaseResponse> onSuccess) {
            if (!IsPlatformSupported(onFailure)) {
                return;
            }
        ...
        public void DeletePurchase(string purchaseId, Action<RuStoreError> onFailure, Action<DeletePurchaseResponse> onSuccess) {
            if (!IsPlatformSupported(onFailure)) {
                return;
            }
